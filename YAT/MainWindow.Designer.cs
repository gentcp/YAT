...
namespace YAT
{
    partial class MainWindow
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.m_CTableLPanel.ColumnCount = 3;
            this.m_CTableLPanel.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 50F));
            this.m_CTableLPanel.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 50F));
            this.m_CTableLPanel.ColumnStyles.Add(new ColumnStyle(SizeType.Absolute, 80F));
            this.m_CTableLPanel.RowCount = 7;
            ...
            this.m_CTableLPanel.Controls.Add(this.m_FComboBox, 0, 1);
            this.m_CTableLPanel.Controls.Add(this.m_TComboBox, 1, 1);
            this.m_CTableLPanel.Controls.Add(this.m_TButton, 2, 1);
            this.m_CTableLPanel.Controls.Add(this.m_FLabel, 0, 2);
            this.m_CTableLPanel.Controls.Add(this.m_FRichTextBox, 0, 3);
            this.m_CTableLPanel.Controls.Add(this.m_TLabel, 0, 4);
            this.m_CTableLPanel.Controls.Add(this.m_TRichTextBox, 0, 5);
            this.m_CTableLPanel.Controls.Add(this.m_StatusStrip, 0, 6);
            this.m_CTableLPanel.SetColumnSpan(this.m_MenuStrip, 3);
            this.m_CTableLPanel.SetColumnSpan(this.m_FLabel, 3);
            this.m_CTableLPanel.SetColumnSpan(this.m_FRichTextBox, 3);
            this.m_CTableLPanel.SetColumnSpan(this.m_TLabel, 3);
            this.m_CTableLPanel.SetColumnSpan(this.m_TRichTextBox, 3);
            this.m_CTableLPanel.SetColumnSpan(this.m_StatusStrip, 3);
