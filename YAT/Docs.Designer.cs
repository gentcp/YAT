    ...
    internal class Docs
    {
        ...
        internal static ResourceManager ResourceManager
        {
            get
            {
                ...
                {
                    m_ResourceManager = new ResourceManager("YAT.Docs", typeof(Docs).Assembly);
                }
        ...
        internal static string LICENSE
        {
            get
            {
                return ResourceManager.GetString("LICENSE", m_ResourceCulture);
            }
        }
        internal static string APIKey
        {
            get
            {
                return ResourceManager.GetString("APIKey", m_ResourceCulture);
            }
        }
    }
}
